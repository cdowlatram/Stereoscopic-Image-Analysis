      ...
      <div>
        ...
        <div className="text-left">
          <div className="custom-control custom-radio custom-control-inline">
            <input type="radio" id="unit-mm" name="unit" className="custom-control-input" 
              checked={this.props.unit}
              onChange={this.props.onChangeHandler}/>
            <label className="custom-control-label" htmlFor="unit-mm">mm</label>
          </div>
          <div className="custom-control custom-radio custom-control-inline">
            <input type="radio" id="unit-cm" name="unit" className="custom-control-input" 
              checked={this.props.unit}
              onChange={this.props.onChangeHandler}/>
            <label className="custom-control-label" htmlFor="unit-cm">cm</label>
          </div>
          <div className="custom-control custom-radio custom-control-inline">
            <input type="radio" id="unit-m" name="unit" className="custom-control-input" 
              checked={this.props.unit}
              onChange={this.props.onChangeHandler}/>
            <label className="custom-control-label" htmlFor="unit-m">m</label>
          </div>
          <div className="custom-control custom-radio custom-control-inline">
            <input type="radio" id="unit-in" name="unit" className="custom-control-input" 
              checked={this.props.unit}
              onChange={this.props.onChangeHandler}/>
            <label className="custom-control-label" htmlFor="unit-in">in</label>
          </div>
          <div className="custom-control custom-radio custom-control-inline">
            <input type="radio" id="unit-ft" name="unit" className="custom-control-input" 
              checked={this.props.unit}
              onChange={this.props.onChangeHandler}/>
